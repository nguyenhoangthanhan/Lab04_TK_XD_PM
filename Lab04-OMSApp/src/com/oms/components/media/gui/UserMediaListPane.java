		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (controller instanceof UserMediaPageController) {
					if(singlePane instanceof PhysicalMediaSinglePane)
					((UserMediaPageController) controller).addToCart(singlePane.getData().getId(), singlePane.getData().getTitle(), singlePane.getData().getCost(), (int)spin.getValue(), ((PhysicalMediaSinglePane) singlePane).getWeight());
				}
			}
		});
	}
